...
public final class CrashUtil {
    ...
    static {
        ...
        CRASH_HEAD = "************* Crash Log Head ****************" +
                "\nDevice Manufacturer: " + Build.MANUFACTURER +// equipment厂商
                "\nDevice Model       : " + Build.MODEL +// equipment型号
        ...
        UNCAUGHT_EXCEPTION_HANDLER = new UncaughtExceptionHandler() {
            ...
            public void uncaughtException(final Thread t, final Throwable e) {
                ...
                if (DEFAULT_UNCAUGHT_EXCEPTION_HANDLER != null) {
                    // 如果group name没有处理则让系统默认的异常处理器来处理
     ...
     *
     * @param e
     * @return true  Save 成功   false  Save 失败
     */
    public static boolean saveCrashInfoFile(final Throwable e) {
        ...
        if (!createOrExistsFile(fullPath)) {
            TUtil.showShort("Crash文件 Save 目录创建失败！");
            return false;
        }
