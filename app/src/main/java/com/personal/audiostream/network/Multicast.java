    ...
    private Multicast() {
        try {
            ...
            if (!inetAddress.isMulticastAddress()) {
                //pushMsgToMain(UDP_HANDLER_MESSAGE_TOAST, "IPaddress不是组播address（224.0.0.0~239.255.255.255）");
                return;
            }
            ...
            multicastSendSocket.joinGroup(inetAddress);//加入多播组， send 方和接受方处于同一组时，接收方可抓取多播报文信息
            ...
            multicastReceiveSocket.joinGroup(inetAddress);//加入多播组， send 方和接受方处于同一组时，接收方可抓取多播报文信息
