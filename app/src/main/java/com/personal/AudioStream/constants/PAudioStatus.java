...
public class PAudioStatus {
    ...
    public static final int STATUS_USER_DEFINED_READY1      = 0x61001;       //用户定义准备1
    public static final int STATUS_USER_DEFINED_READY2      = 0x61002;       //用户定义准备2
    ...
    public static final int STATUS_STOP                       = 0x61006;      //停止录音状态
