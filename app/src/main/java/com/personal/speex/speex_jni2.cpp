...
#define TAG "Voice_*C*_Speex2" // LOG标志
...
JNICALL
Java_com_personal_speex_Speex2Util_open(
        JNIEnv *env,
...
JNICALL
Java_com_personal_speex_Speex2Util_getFrameSize(
        JNIEnv *env,
        jobject /* this */) {
    if (!codec_open)
        return 0;
...
JNICALL
Java_com_personal_speex_Speex2Util_decode(
        JNIEnv *env,
...
JNICALL
Java_com_personal_speex_Speex2Util_encode(
        JNIEnv *env,
...
JNICALL
Java_com_personal_speex_Speex2Util_close(
        JNIEnv *env,
        jobject /* this */) {
